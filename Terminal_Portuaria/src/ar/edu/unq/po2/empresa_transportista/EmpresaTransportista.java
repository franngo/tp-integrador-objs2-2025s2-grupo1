...
public class EmpresaTransportista {
	...
	private void validarContratarCamion() {
		if(!this.tieneCamionDisponible()) {
			throw new RuntimeException("No hay ningún camión disponible para ser contratado.");
		}
	}
	...
	private void validarContratarChofer() {
		if(!this.tieneChoferDisponible()) {
			throw new RuntimeException("No hay ningún chofer disponible para ser contratado.");
		}
	}
